...
<html lang="en">
<head>
  <title>Ekiensnews | Health News</title>
...
<body class="style-games single-post bg-light">
  ...
  <header class="sidenav" id="sidenav">
    ...
    <!-- Nav -->
       ...
       $depcat = $_GET['depcat'];
       $query = mysqli_query($con,"select * from healthnews where id='$depcat'");
		...
		if( $admin_query = mysqli_query($con,"select * from healthnews"))
                    ...
                    <div class="entry__img-holder thumb__img-holder" style="background-image: url('admin/<?php echo $row['image'];?>');">
                      ...
                      <div class="thumb-text-holder">   
                        ...
                        <a href="healthnews.php?depcat=<?php echo $row['id'];?>" title="<?php echo $row['tilte'];?>"> <?php echo $row['title'];?> </a>
                        </h2>
                      </div>
                    </div>
                  </article>
         ...
         <!-- end widget socials -->
          ...
          <aside class="widget widget-popular-posts">
            ...
            <ul class="post-list-small">
              <?php
		if( $admin_query = mysqli_query($con,"select * from healthnews limit 6"))
			                  {
			                 $num   = mysqli_num_rows($admin_query);
			                 while($row = mysqli_fetch_array($admin_query))
			                  {
