...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from lifesnews
						where id  = '".$_GET['did']."' ");
			header('location:life_news.php');
		}

$q=mysqli_query($con,"select * from lifesnews");
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Life News</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Life News</h1>
			<!-- end page-header -->
              		...
              		?>
						<tbody>
							<tr class="odd gradeX">
                             ...
                             <a class="btn btn-danger" href = "life_news.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
                             </td>
                             </tr>
