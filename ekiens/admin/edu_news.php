...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from edunews
						where id  = '".$_GET['did']."' ");
			header('location:edu_news.php');
		}

$q=mysqli_query($con,"select * from edunews");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Education News</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Education News</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Education News</h1>
			<!-- end page-header -->
              		...
              		?>
						<tbody>
							<tr class="odd gradeX">
                             ...
                             <a class="btn btn-danger" href = "edu_news.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
							  <hr>
							  <a class="btn btn-success" href = "edit_edu_news.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-yellow"><i class="glyphicon glyphicon-trash icon-white"></i>Edit</a>
                             </td>
                             </tr>
                             <?php
                            	}
