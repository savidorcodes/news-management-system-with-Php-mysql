...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from entertainmentnews
						where id  = '".$_GET['did']."' ");
			header('location:enter_news.php');
		}

$q=mysqli_query($con,"select * from entertainmentnews");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Fashion News</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Entertainment News</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Entertainment News</h1>
			<!-- end page-header -->
              		...
              		?>
						<tbody>
							<tr class="odd gradeX">
                             ...
                             <a class="btn btn-danger" href = "enter_news.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
							  <hr>
							  <a class="btn btn-success" href = "edit_enter_news.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-yellow"><i class="glyphicon glyphicon-trash icon-white"></i>Edit</a>
                             </td>
                             </tr>
                             <?php
                            	}
