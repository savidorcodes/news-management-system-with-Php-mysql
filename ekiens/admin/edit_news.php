...
$q=mysqli_query($con,"update businessnews set title='$title',descn='$descn',news='$news',image='$image',tag='$tag',year='$year',month='$month',date='$date',author_name='$author_name',author_email='$author_email' where id='$id'");
	}

	if($q)
	{
	   echo "<script>
    window.location = 'bus_news.php';
</script>";
  exit;
   }
   else
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Edit Business News</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Edit Business News</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Business News <small></small></h1>
			<!-- end page-header -->
			
            <!-- begin wizard-form -->
            <?php
          	$adminquery=mysqli_query($con,"select * from news where id='$id'");
					...
					<ul>
						...
						<li class="col-md-3 col-sm-4 col-6">
							<a href="#step-2">
								...
								<span class="info text-ellipsis">
									News Attribute
									<small class="text-ellipsis">image, Tag, Date</small>
								</span>
							</a>
						</li>
						<li class="col-md-3 col-sm-4 col-6">
							<a href="#step-3">
								...
								<span class="info text-ellipsis">
									Author's Info
									<small class="text-ellipsis"> Name and Email Address </small>
								</span>
							</a>
						</li>
						<li class="col-md-3 col-sm-4 col-6">
							<a href="#step-4">
								...
								<span class="info text-ellipsis">
									Completed
									<small class="text-ellipsis">News Created Successfully</small>
								</span>
							</a>
						</li>
					</ul>
					...
					<div>
						...
						<div id="step-1">
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-8 offset-md-2">
										...
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="text" name="title" value="<?php echo $row['title']; ?>" data-parsley-group="step-1" data-parsley-required="false" class="form-control" />
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="text" name="descn" value="<?php echo $row['descn']; ?>" data-parsley-group="step-1" data-parsley-required="false" class="form-control" />
											</div>
										</div>
									</div>
									<!-- end col-8 -->
								...
								<textarea class="ckeditor" id="editor1" name="news" rows="20"></textarea>
									</div>
								</div>
								<!-- end row -->
							</fieldset>
								...
								<div class="row">
									...
									<div class="col-md-8 md-offset-2">
										...
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="file" name="image" placeholder="" data-parsley-group="step-2" data-parsley-required="true" class="form-control" />
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
								...
								<div class="row">
									...
									<div class="col-md-8 offset-md-2">
										...
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="text" name="author_name" placeholder="Tochi" class="form-control" data-parsley-group="step-3" data-parsley-required="true"/>
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="email" name="author_email" placeholder="luthtech18@gmail.com" class="form-control" data-parsley-group="step-3" data-parsley-required="true" />
											</div>
										</div>
									</div>
									<!-- end col-8 -->
						...
						<div id="step-4">
							<div class="jumbotron m-b-0 text-center">
								...
								<p class="m-b-30 f-s-16">Your News as been Created successfuly.<br/> Click on the PUBLISH to make it available</p>
								<button type="submit" name="submit" class="btn btn-primary btn-lg">PUBLISH</button>
							</div>
						</div>
						<!-- end step-4 -->
					</div>
