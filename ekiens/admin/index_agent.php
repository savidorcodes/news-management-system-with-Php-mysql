...
{
	   echo "<script>
    window.location = 'agent_login.php';
</script>";
}
?>
<!DOCTYPE html>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand"><span class="navbar-logo"><i class="ion-ios-cloud"></i></span> <b>Ekiensnews</b> Admin Panel</a>
			...
			<ul class="navbar-nav navbar-right">
                ...
                <?php
          	$adminquery=mysqli_query($con,"select * from admin2");
          	...
          	?>
				<li class="dropdown navbar-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
						...
						<span class="d-none d-md-inline"><?php echo $row['fullname']; ?></span> <b class="caret"></b>
					</a>
