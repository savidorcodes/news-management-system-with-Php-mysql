...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from adverts
						where id  = '".$_GET['did']."' ");
			header('location:adverts.php');
		}

$q=mysqli_query($con,"select * from adverts");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Adverts</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Adverts</h1>
			<!-- end page-header -->
				...
				<div class="panel-body">
					<table id="data-table-default" class="table table-striped table-bordered">
						<thead>
							<tr>
								...
								<th class="text-nowrap">Company's Name</th>
								<th class="text-nowrap">Company's Email</th>
              	   ...
              	   while($row=mysqli_fetch_array($q))
              	  {
              		?>
						<tbody>
							<tr class="odd gradeX">
								<td width="1%" class="f-s-600 text-inverse"><?php echo $row['package']; ?></td>
                             ...
                             <a class="btn btn-danger" href = "adverts.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
                             </td>
                             </tr>
