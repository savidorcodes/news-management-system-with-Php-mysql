...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from aboutus
						where id  = '".$_GET['did']."' ");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | About Us</title>
              		...
              		?>
						<tbody>
                            ...
                            <td><?php echo $row['id']; ?></td>
                             ...
                             <a class="btn btn-danger" href = "aboutus.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
							  <hr>
							  <a class="btn btn-success" href = "edit_aboutus.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-yellow"><i class="glyphicon glyphicon-trash icon-white"></i>Edit</a>
                             </td>
                             </tr>
                             <?php
                            	}
