...
$author_email=mysqli_real_escape_string($con, $_POST['author_email']);
	...
	{
    $q=mysqli_query($con,"update technews set title='$title',descn='$descn',news='$news',tag='$tag',year='$year',month='$month',date='$date',author_name='$author_name',author_email='$author_email',image='$image' where id='$id'");
	}
	else
	{
		$q=mysqli_query($con,"update technews set title='$title',descn='$descn',news='$news',tag='$tag',year='$year',month='$month',date='$date',author_name='$author_name',author_email='$author_email',image='$image' where id='$id'");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Edit Technology News</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Edit Technology News</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Technology News <small></small></h1>
			<!-- end page-header -->
			
            <!-- begin wizard-form -->
            <?php
            $query=mysqli_query($con,"select * from technews where id='$id'");
