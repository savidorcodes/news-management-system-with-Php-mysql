              		...
              		?>
						<tbody>
							<tr class="odd gradeX">
                             ...
                             <a class="btn btn-danger" href = "fashion_news.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
                              </a>
                             </td>
                             </tr>
