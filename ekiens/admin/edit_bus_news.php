...
$author_email=mysqli_real_escape_string($con, $_POST['author_email']);
	...
	{
    $q=mysqli_query($con,"update businessnews set title='$title',descn='$descn',news='$news',tag='$tag',year='$year',month='$month',date='$date',author_name='$author_name',author_email='$author_email',image='$image' where id='$id'");
	}
	else
	{
		$q=mysqli_query($con,"update businessnews set title='$title',descn='$descn',news='$news',tag='$tag',year='$year',month='$month',date='$date',author_name='$author_name',author_email='$author_email',image='$image' where id='$id'");
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <!-- begin wizard-form -->
            <?php
            $query=mysqli_query($con,"select * from businessnews where id='$id'");
