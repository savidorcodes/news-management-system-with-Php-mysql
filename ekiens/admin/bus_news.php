...
if(isset($_GET['did'] ) && $_GET['todo']=="delete")
		{
				mysqli_query($con,"delete from businessnews
						where id  = '".$_GET['did']."' ");
			header('location:bus_news.php');
		}

$q=mysqli_query($con,"select * from businessnews");
...
<head>
	<meta charset="utf-8" />
	<title>Ekiensnews Admin | Business News</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Business News</h1>
			<!-- end page-header -->
              		...
              		?>
						<tbody>
							<tr class="odd gradeX">
                             ...
                             <a class="btn btn-danger" href = "bus_news.php?todo=delete&did=<?php echo $row['id'] ?>" role="button" onclick = "return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash icon-white"></i>
                               Delete
							  </a>
							  <hr>
							  <a class="btn btn-success" href = "edit_bus_news.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-yellow"><i class="glyphicon glyphicon-trash icon-white"></i>Edit</a>
                             </td>
                             </tr>
                             <?php
                            	}
