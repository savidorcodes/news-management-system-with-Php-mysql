...
<body class="style-games single-post bg-light">
  ...
  <header class="sidenav" id="sidenav">
    ...
    <!-- Entry Image -->
       ...
       $depcat = $_GET['depcat'];
       $queryh = mysqli_query($con,"select * from edunews where title='$depcat'");
                             
        while($hrow = mysqli_fetch_assoc($queryh))
        {
        $id=$hrow['id'];
    ...
    <div class="thumb thumb--size-6">
      <div class="entry__img-holder thumb__img-holder" style="background-image: url('admin/<?php echo $hrow['image'];?>');">
      </div>
    </div>
          ...
          <div class="content-box content-box--top-offset">
            ...
            <article class="entry mb-0">
              ...
              <section class="section related-posts mt-40 mb-0">
                ...
                <?php
		if( $admin_query = mysqli_query($con,"select * from edunews"))
			                  {
                    ...
                    <div class="entry__img-holder thumb__img-holder" style="background-image: url('admin/<?php echo $row['image'];?>');">
                      ...
                      <div class="thumb-text-holder">   
                        ...
                        <a href="healthnews.php?depcat=<?php echo $row['title'];?>" title="<?php echo $row['tilte'];?>"> <?php echo $row['title'];?> </a>
                        </h2>
                      </div>
                    </div>
                  </article>
        ...
        <aside class="col-lg-4 sidebar sidebar--right">
          ...
          <aside class="widget widget-popular-posts">
            ...
            <ul class="post-list-small">
              <?php
		if( $admin_query = mysqli_query($con,"select * from healthnews"))
			                  {
			                 $num   = mysqli_num_rows($admin_query);
			                 while($row = mysqli_fetch_array($admin_query))
			                  {
