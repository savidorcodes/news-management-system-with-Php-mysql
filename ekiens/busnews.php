...
<body class="style-games single-post bg-light">
  ...
  <header class="sidenav" id="sidenav">
    ...
    <!-- Entry Image -->
       ...
       $depcat = $_GET['depcat'];
       $query = mysqli_query($con,"select * from businessnews where title='$depcat'");
		...
		if( $admin_query = mysqli_query($con,"select * from businessnews"))
                    ...
                    <div class="entry__img-holder thumb__img-holder" style="background-image: url('admin/<?php echo $row['image'];?>');">
                      ...
                      <div class="thumb-text-holder">   
                        ...
                        <a href="busnews.php?depcat=<?php echo $row['title'];?>" title="<?php echo $row['tilte'];?>"> <?php echo $row['title'];?> </a>
                        </h2>
                      </div>
                    </div>
                  </article>
